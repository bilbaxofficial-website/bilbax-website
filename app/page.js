    ...
    <section class="section pricing-section" id="pricing">
      <div class="container">
        ...
        <div class="price-grid">
          <article class="price-card reveal"><h3>Free</h3><p>For getting your first automation live.</p><div class="price">₹0</div><ul class="price-list"><li>✓ 500 DMs / month</li><li>✓ 1 Instagram account</li><li>✓ Keyword automations</li></ul><button class="btn" type="button" data-plan="Free">Start free <span>→</span></button><div class="price-feedback" data-plan-feedback></div></article>
          <article class="price-card featured reveal"><span class="price-tag">Most popular</span><h3>Grow</h3><p>For creators with a busy inbox.</p><div class="price">₹799 <small>/ month</small></div><ul class="price-list"><li>✓ 5,000 DMs / month</li><li>✓ AI replies + lead capture</li><li>✓ Priority support</li></ul><button class="btn" type="button" data-plan="Grow">Start growing <span>→</span></button><div class="price-feedback" data-plan-feedback></div></article>
          <article class="price-card reveal"><h3>Scale</h3><p>For teams turning replies into revenue.</p><div class="price">₹1,999 <small>/ month</small></div><ul class="price-list"><li>✓ Unlimited workflows</li><li>✓ 10 Instagram accounts</li><li>✓ Advanced analytics</li></ul><button class="btn" type="button" data-plan="Scale">Talk to us <span>→</span></button><div class="price-feedback" data-plan-feedback></div></article>
        </div>
      </div>
    </section>
